...
preOrderTraverse :: Tree k v -> [k]


traverse :: Tree k v -> [Char] -> [k]

traverse tr "preorder" = preOrderTraverse tr
traverse tr "symmetric" = symmetricTraverse tr
traverse tr "postoder" = postOrderTraverse tr
traverse _ _ = ()
